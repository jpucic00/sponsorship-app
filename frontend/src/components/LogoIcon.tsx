// Custom Heart with Child Icon Component
export const LogoIcon = ({ size = 24, className = "" }) => {
  return (
    ...
    >
      ...
      <path
        d="M16,26 C16,26 8,18 8,13 C8,10 10,8 13,8 C14.5,8 15.5,9 16,10 C16.5,9 17.5,8 19,8 C22,8 24,10 24,13 C24,18 16,26 16,26 Z"
        fill="#ffffff"
      />
