...
interface Child {
  ...
  // Image fields from photo gallery
...
export const ChildrenTableDesktop: React.FC<ChildrenTableDesktopProps> = ({
  ...
  // Function to get image source for a child (now uses profile photo from gallery)
  const getImageSrc = (child: Child) => {
    if (child.photoDataUrl) {
      return child.photoDataUrl;
    }
    // Fallback to profile photo API endpoint
